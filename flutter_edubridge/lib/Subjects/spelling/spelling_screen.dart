            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  "Enhance your spelling skills through interactive exercises, word lists, and quizzes. "
                  "Learn correct spelling, understand patterns, and expand your vocabulary.",
                ...
                sectionCard(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: const [
                      Text("• Master correct spelling of common words"),
                      Text("• Recognize and use spelling patterns"),
                      Text("• Enhance vocabulary and word usage"),
                ...
                sectionCard(
                  ...
                  child: Column(
                    children: [
                      lessonButton(context, "Lesson 1: Introduction to Spelling", const SpellingLessonOne()),
                      lessonButton(context, "Lesson 2: Common Word Lists", const SpellingLessonTwo()),
                      lessonButton(context, "Lesson 3: Spelling Practice Activities", const SpellingLessonThree()),
                    ],
                  ),
                ),
                const SizedBox(height: 12),
